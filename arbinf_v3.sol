...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = 16;
    uint256 private constant ARB_CLASS_SIZE_BPS = 5;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = 5000;

    uint256 private constant ARB_CONF_DECAY_PCT = 86;
    uint256 private constant ARB_CONF_HIT_BPS = 2800;
    uint256 private constant ARB_CONF_MISS_BPS = 400;

    uint256 private constant ARB_ALPHA_PCT = 26;
    uint256 private constant RETAIL_ALPHA_PCT = 13;
    uint256 private constant RETAIL_INV_W_PCT = 60;

    uint256 private constant ARB_JUMP_BPS = 550;
    uint256 private constant RETAIL_JUMP_BPS = 280;

    uint256 private constant CONF_GATE_BPS = 3800;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = 1;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = 120;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = 80;
