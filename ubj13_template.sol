...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_ALPHA_PCT = __INV_ALPHA_PCT__;
    ...
    uint256 private constant SKEW_ALPHA_PCT = __SKEW_ALPHA_PCT__;
    uint256 private constant SKEW_DEADBAND_BPS = __SKEW_DEADBAND_BPS__;
    uint256 private constant SKEW_DIV = __SKEW_DIV__;
    uint256 private constant SKEW_MAX_BPS = __SKEW_MAX_BPS__;
    uint256 private constant SKEW_STREAK_BONUS_BPS = __SKEW_STREAK_BONUS_BPS__;

    uint256 private constant BIAS_ENTER_BPS = __BIAS_ENTER_BPS__;
    uint256 private constant BIAS_FLIP_BPS = __BIAS_FLIP_BPS__;
    uint256 private constant BIAS_HOLD_STEPS = __BIAS_HOLD_STEPS__;
