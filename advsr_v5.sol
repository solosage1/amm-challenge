...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CP_FLIP_BONUS_BPS = 24;
    uint256 private constant CP_TOWARD_BONUS_BPS = 24;
    uint256 private constant CP_SIGNAL_CAP_BPS = 190;
    uint256 private constant CP_ALPHA_PCT = 16;
    uint256 private constant CP_DECAY_PCT = 84;
    uint256 private constant CP_REPLAY_WINDOW = 4;
    uint256 private constant CP_REPLAY_SIGNAL_FLOOR_BPS = 20;
    uint256 private constant CP_REPLAY_BONUS_BPS = 24;

    // Stress mode hysteresis.
    uint256 private constant STRESS_ENTER_BPS = 33;
    uint256 private constant STRESS_EXIT_BPS = 16;
    uint256 private constant STRESS_INSTANT_BPS = 54;
    uint256 private constant STRESS_MIN_HOLD_STEPS = 5;

    // Stress-mode spread/undercut clamps.
    uint256 private constant STRESS_TIGHT_ADD_BPS = 2;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 28;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 280;
    uint256 private constant STRESS_COMP_FLOOR_BPS = 22;
    uint256 private constant STRESS_MAX_SPREAD_BPS = 52;
    uint256 private constant STRESS_POST_ARB_CUT_SCALE_PCT = 35;
