...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant SKEW_DEADBAND_BPS = 7;
    uint256 private constant SKEW_DIV = 6;
    uint256 private constant SKEW_MAX_BPS = 5;
    uint256 private constant SKEW_STREAK_BONUS_BPS = 1;

    uint256 private constant BIAS_ENTER_BPS = 5;
    uint256 private constant BIAS_FLIP_BPS = 9;
    uint256 private constant BIAS_HOLD_STEPS = 2;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 60;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 70;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 10;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 50;
