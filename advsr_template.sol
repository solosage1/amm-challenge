...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CP_JUMP_W_PCT = __CP_JUMP_W_PCT__;
    uint256 private constant CP_MIS_W_PCT = __CP_MIS_W_PCT__;
    uint256 private constant CP_FLIP_BONUS_BPS = __CP_FLIP_BONUS_BPS__;
    uint256 private constant CP_TOWARD_BONUS_BPS = __CP_TOWARD_BONUS_BPS__;
    uint256 private constant CP_SIGNAL_CAP_BPS = __CP_SIGNAL_CAP_BPS__;
    uint256 private constant CP_ALPHA_PCT = __CP_ALPHA_PCT__;
    uint256 private constant CP_DECAY_PCT = __CP_DECAY_PCT__;
    uint256 private constant CP_REPLAY_WINDOW = __CP_REPLAY_WINDOW__;
    uint256 private constant CP_REPLAY_SIGNAL_FLOOR_BPS = __CP_REPLAY_SIGNAL_FLOOR_BPS__;
    uint256 private constant CP_REPLAY_BONUS_BPS = __CP_REPLAY_BONUS_BPS__;

    // Stress mode hysteresis.
    uint256 private constant STRESS_ENTER_BPS = __STRESS_ENTER_BPS__;
    uint256 private constant STRESS_EXIT_BPS = __STRESS_EXIT_BPS__;
    uint256 private constant STRESS_INSTANT_BPS = __STRESS_INSTANT_BPS__;
    uint256 private constant STRESS_MIN_HOLD_STEPS = __STRESS_MIN_HOLD_STEPS__;

    // Stress-mode spread/undercut clamps.
    uint256 private constant STRESS_TIGHT_ADD_BPS = __STRESS_TIGHT_ADD_BPS__;
    ...
    uint256 private constant STRESS_COMP_FLOOR_BPS = __STRESS_COMP_FLOOR_BPS__;
    uint256 private constant STRESS_MAX_SPREAD_BPS = __STRESS_MAX_SPREAD_BPS__;
    uint256 private constant STRESS_POST_ARB_CUT_SCALE_PCT = __STRESS_POST_ARB_CUT_SCALE_PCT__;
