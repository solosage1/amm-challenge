...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARM0_TIGHT_CENTI_BPS = 2808;
    uint256 private constant ARM1_TIGHT_CENTI_BPS = 2788;
    uint256 private constant ARM2_TIGHT_CENTI_BPS = 2768;

    uint256 private constant ARM0_UNDERCUT_CENTI_BPS = 985;
    uint256 private constant ARM1_UNDERCUT_CENTI_BPS = 1050;
    uint256 private constant ARM2_UNDERCUT_CENTI_BPS = 1130;

    uint256 private constant ARM0_BUFFER_CENTI_BPS = 225;
    uint256 private constant ARM1_BUFFER_CENTI_BPS = 200;
    uint256 private constant ARM2_BUFFER_CENTI_BPS = 175;
    ...
    uint256 private constant WIDE_SIGNAL_DIV = 11;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = 5;
    uint256 private constant WIDE_COMP_BONUS_PCT = 61;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = 59;

    // Meta-learning / gating.
    uint256 private constant META_AGGR_ALPHA_PCT = 19;
    uint256 private constant META_RISK_ALPHA_PCT = 21;
    uint256 private constant META_MAG_CAP_BPS = 13;
    uint256 private constant META_CLAMP_BPS = 520;

    uint256 private constant RISK_ARM_TRIG_BPS = 34;
    uint256 private constant AGGR_ARM_TRIG_BPS = 24;
    uint256 private constant AGGR_MAX_RISK_BPS = 24;

    uint256 private constant CONF_GATE_BPS = 4800;
    uint256 private constant CONF_UP_BPS = 88;
    uint256 private constant CONF_DOWN_BPS = 158;
    uint256 private constant CONF_MISS_BPS = 46;
