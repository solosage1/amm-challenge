...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant LATENT_UP_BPS = 110;
    uint256 private constant LATENT_DOWN_BPS = 130;
    uint256 private constant LATENT_DRIFT_BPS = 350;
    uint256 private constant RETAIL_ENTER_BPS = 5600;
    uint256 private constant DEFENSE_ENTER_BPS = 4400;
    uint256 private constant RETAIL_EXIT_BPS = 5250;
    uint256 private constant DEFENSE_EXIT_BPS = 4750;
    uint256 private constant MODE_TIGHT_SHIFT_BPS = 1;
    uint256 private constant MODE_UNDERCUT_SHIFT_BPS = 1;
    uint256 private constant MODE_BUFFER_SHIFT_BPS = 1;
    uint256 private constant MODE_POST_ARB_CUT_BPS = 2;
    uint256 private constant EVIDENCE_MIS_BPS = 34;
    uint256 private constant EVIDENCE_QUIET_BPS = 19;
