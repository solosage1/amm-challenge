...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ENTER_MIS_BPS = 50;
    uint256 private constant EXIT_MIS_BPS = 32;
    uint256 private constant NORMAL_MIS_BPS = 24;

    uint256 private constant ENTER_INV_BPS = 210;
    uint256 private constant EXIT_INV_BPS = 170;
    uint256 private constant NORMAL_INV_BPS = 150;

    uint256 private constant DEF_COOLDOWN = 4;
    ...
    uint256 private constant DEF_BUF_BPS = 5;

    uint256 private constant NORM_UNDER_BPS = 10;
    uint256 private constant REC_UNDER_BPS = 14;
    uint256 private constant DEF_UNDER_BPS = 2;

    uint256 private constant TILT_TRIGGER_BPS = 190;
    uint256 private constant TILT_NORM_BPS = 1;
