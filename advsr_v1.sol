...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CP_JUMP_W_PCT = 55;
    uint256 private constant CP_MIS_W_PCT = 45;
    uint256 private constant CP_FLIP_BONUS_BPS = 12;
    uint256 private constant CP_TOWARD_BONUS_BPS = 16;
    uint256 private constant CP_SIGNAL_CAP_BPS = 160;
    uint256 private constant CP_ALPHA_PCT = 10;
    uint256 private constant CP_DECAY_PCT = 90;
    uint256 private constant CP_REPLAY_WINDOW = 2;
    uint256 private constant CP_REPLAY_SIGNAL_FLOOR_BPS = 35;
    uint256 private constant CP_REPLAY_BONUS_BPS = 8;

    // Stress mode hysteresis.
    uint256 private constant STRESS_ENTER_BPS = 9999;
    uint256 private constant STRESS_EXIT_BPS = 9998;
    uint256 private constant STRESS_INSTANT_BPS = 9999;
    uint256 private constant STRESS_MIN_HOLD_STEPS = 1;

    // Stress-mode spread/undercut clamps.
    uint256 private constant STRESS_TIGHT_ADD_BPS = 0;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 0;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 0;
    uint256 private constant STRESS_COMP_FLOOR_BPS = 0;
    uint256 private constant STRESS_MAX_SPREAD_BPS = 1000;
    uint256 private constant STRESS_POST_ARB_CUT_SCALE_PCT = 100;
