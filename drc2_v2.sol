...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant EWMA_LOSS_NEW_PCT = 8;
    uint256 private constant EWMA_TAIL_NEW_PCT = 10;

    uint256 private constant STRESS_ENTER_BPS = 110;
    uint256 private constant STRESS_EXIT_BPS = 82;

    uint256 private constant AMBIGUITY_PCT = 15;
    uint256 private constant VOL_WEIGHT_PCT = 8;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 8;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 5;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 90;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 30;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 8;
    uint256 private constant STRESS_BAND_CUT_BPS = 0;

    uint256 private constant PANIC_SCORE_BPS = 150;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 12;
