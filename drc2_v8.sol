...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_ENTER_BPS = 98;
    uint256 private constant STRESS_EXIT_BPS = 72;

    uint256 private constant AMBIGUITY_PCT = 22;
    uint256 private constant VOL_WEIGHT_PCT = 9;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 14;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 4;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 120;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 50;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 11;
    uint256 private constant STRESS_BAND_CUT_BPS = 1;

    uint256 private constant PANIC_SCORE_BPS = 135;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 18;
