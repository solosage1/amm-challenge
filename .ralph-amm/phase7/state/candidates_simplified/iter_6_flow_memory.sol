...
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        uint256 mis = wdiv(absDiff(spot, fair), fair); // mock mutation iter=1 mechanism=flow_memory // mock mutation iter=6 mechanism=flow_memory
