...
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        // Update fair once per step from first observed trade (arb anchor when present). // mock mutation iter=5 mechanism=fair_price_estimation // mock mutation iter=9 mechanism=fair_price_estimation
    ...
    function getName() external pure override returns (string memory) {
        return "fair_price_estimation_mod_v9";
    }
}
