...
Per-timestamp gamma-anchored fair-price candidate with jump clamp and 80/20 EWMA update.

### Code Location
afterSwap lines 49-70
...
5. Set getName() return value to "fair_price_estimation_mod_v5"
