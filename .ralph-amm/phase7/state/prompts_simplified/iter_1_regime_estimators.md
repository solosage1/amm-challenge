...
## YOUR TASK
Modify the **regime_estimators** mechanism to improve expected edge.

### Current Implementation
Step-boundary decay and estimator updates for sigma/lambda/size/activity/step counters.

### Code Location
afterSwap step boundary and estimator maintenance
...
## CONSTRAINTS
1. ONLY modify code related to regime_estimators
2. Keep all other mechanisms unchanged:
fair_price_and_arb, toxicity_and_activity, directional_skew_and_stale_protection, tail_compression
3. Output a complete, compilable Solidity contract
4. Keep contract declaration as `contract Strategy`
5. Set getName() return value to "regime_estimators_mod_v1"
