...
Within tight band, both bid and ask are pinned to 30 bps to avoid unnecessary undercutting.

### Code Location
afterSwap lines 84-88
...
5. Set getName() return value to "tight_band_pricing_mod_v7"
