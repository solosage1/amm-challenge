...
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) {
        return "tight_band_pricing_mod_v3";
    }
}
...
Protective side sets required fee from gamma requirement plus buffer when spot deviates from fair.

### Code Location
afterSwap lines 91-97, 103-107
