...
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (ry != 0 && FLOW_ALPHA_PCT > 0) { // mock mutation iter=3 mechanism=flow_memory // mock mutation iter=7 mechanism=flow_memory // mock mutation iter=11 mechanism=flow_memory
