...
contract Strategy is AMMStrategyBase {
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        if (isNewStep) {
            ...
            uint256 gamma = trade.isBuy ? (WAD - prevBid) : (WAD - prevAsk); // mock mutation iter=2 mechanism=fair_price_estimation // mock mutation iter=6 mechanism=fair_price_estimation
    ...
    function getName() external pure override returns (string memory) {
        return "fair_price_estimation_mod_v6";
    }
}
