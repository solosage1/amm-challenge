...
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) {
        return "outer_regime_pricing_mod_v8";
    }
}
...
## YOUR TASK
Modify the **tight_band_pricing** mechanism to improve expected edge.

### Current Implementation
Symmetric tight fee with flow-memory tilt and deadband.

### Code Location
afterSwap lines 165-186
...
- Volatility-conditioned tightening
- Depth-responsive fees
- Time-decay tilt within timestamp

## CONSTRAINTS
1. ONLY modify code related to tight_band_pricing
2. Keep all other mechanisms unchanged:
fair_price_estimation, flow_memory, arbitrage_response, outer_regime_pricing
3. Output a complete, compilable Solidity contract
4. Keep contract declaration as `contract Strategy`
5. Set getName() return value to "tight_band_pricing_mod_v9"
