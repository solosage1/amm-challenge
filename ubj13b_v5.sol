...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_MAX_BPS = 5;

    uint256 private constant STREAK_ENTER = 2;
    uint256 private constant STREAK_FLIP_BPS = 4;
    uint256 private constant STREAK_BONUS_MAX_BPS = 5;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 90;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 30;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 30;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 90;
    uint256 private constant BIAS_COMP_MAX_BPS = 5;
    uint256 private constant BIAS_PROTECT_MAX_BPS = 4;
