...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = 17;
    uint256 private constant ARB_CLASS_SIZE_BPS = 6;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = 4800;

    uint256 private constant ARB_CONF_DECAY_PCT = 84;
    uint256 private constant ARB_CONF_HIT_BPS = 2600;
    uint256 private constant ARB_CONF_MISS_BPS = 350;

    uint256 private constant ARB_ALPHA_PCT = 25;
    uint256 private constant RETAIL_ALPHA_PCT = 14;
    uint256 private constant RETAIL_INV_W_PCT = 65;

    uint256 private constant ARB_JUMP_BPS = 520;
    uint256 private constant RETAIL_JUMP_BPS = 300;

    uint256 private constant CONF_GATE_BPS = 3600;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = 1;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = 100;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = 70;
    uint256 private constant CONF_POST_ARB_ADD_BPS = 0;
