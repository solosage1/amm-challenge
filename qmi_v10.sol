...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MICRO_ALPHA_PCT = 22;
    uint256 private constant MICRO_DECAY_PCT = 96;
    uint256 private constant MICRO_MOVE_CAP_BPS = 45;
    uint256 private constant MICRO_DEADBAND_BPS = 5;
    uint256 private constant MICRO_TILT_DIV = 6;
    uint256 private constant MICRO_MAX_TILT_BPS = 2;

    uint256 private constant QUEUE_ALPHA_PCT = 30;
    uint256 private constant QUEUE_DECAY_PCT = 92;
    uint256 private constant QUEUE_TRIGGER = 2;
    uint256 private constant QUEUE_STEP_BPS = 2;
    uint256 private constant QUEUE_MAX_BPS = 7;
    uint256 private constant QUEUE_DEADBAND_BPS = 1;
    uint256 private constant QUEUE_TILT_DIV = 3;
    uint256 private constant QUEUE_MAX_TILT_BPS = 2;
    uint256 private constant QUEUE_GAP_RESET = 1;

    uint256 private constant SIGNAL_FLOW_W_PCT = 45;
    uint256 private constant SIGNAL_MICRO_W_PCT = 30;
    uint256 private constant SIGNAL_QUEUE_W_PCT = 25;
    uint256 private constant EXTRA_TILT_MAX_BPS = 4;

    uint256 private constant WIDE_SIGNAL_DIV = 8;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = 10;
    uint256 private constant WIDE_COMP_BONUS_PCT = 120;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = 120;
