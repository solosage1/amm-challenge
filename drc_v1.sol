...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_EXIT_BPS = 46;

    uint256 private constant AMBIGUITY_PCT = 35;
    uint256 private constant VOL_WEIGHT_PCT = 20;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 30;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 3;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 160;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 120;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 30;
    uint256 private constant STRESS_BAND_CUT_BPS = 1;

    uint256 private constant PANIC_SCORE_BPS = 95;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 30;
