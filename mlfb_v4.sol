...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant RB_STRESS_DECAY_PCT = 86;
    uint256 private constant RB_STRESS_CAP_BPS = 220;
    uint256 private constant RB_SHOCK_CAP_BPS = 160;
    uint256 private constant RB_SHOCK_HARD_BPS = 90;
    ...
    uint256 private constant RB_LOSS_TRIGGER_BPS = 10;
    uint256 private constant RB_LOSS_BONUS_CAP_BPS = 60;
    uint256 private constant RB_REPLAY_STEPS = 1;
    uint256 private constant RB_REPLAY_BONUS_BPS = 6;

    uint256 private constant RB_UNCERT_DECAY_PCT = 88;
    uint256 private constant RB_UNCERT_CAP_BPS = 260;
    uint256 private constant RB_UNCERT_STRESS_WEIGHT_PCT = 50;
    uint256 private constant RB_UNCERT_CONF_WEIGHT_PCT = 50;
    uint256 private constant RB_UNCERT_ENTER_BPS = 170;
    uint256 private constant RB_UNCERT_EXIT_BPS = 80;
    uint256 private constant RB_STRESS_ENTER_BPS = 170;
    uint256 private constant RB_HOLD_STEPS = 1;

    uint256 private constant RB_SAFE_TIGHT_ADD_BPS = 0;
    uint256 private constant RB_SAFE_BUFFER_ADD_CENTI_BPS = 10;
    uint256 private constant RB_SAFE_COMP_CUT_CENTI_BPS = 0;
    uint256 private constant RB_FALLBACK_FEE_CENTI_BPS = 2995;
    uint256 private constant RB_FALLBACK_MIS_MAX_BPS = 16;
