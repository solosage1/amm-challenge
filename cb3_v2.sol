...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CALM_BIAS_ARM2 = 55;
    uint256 private constant STRESS_BIAS_ARM0 = 80;
    uint256 private constant STRESS_BIAS_ARM1 = 35;

    uint256 private constant CALM_UNDERCUT_ADD_CENTI_BPS = 50;
    uint256 private constant CALM_BUFFER_CUT_CENTI_BPS = 20;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 190;
    ...
    uint256 private constant ARM2_TIGHT_CENTI_BPS = 2730;
        ...
        returns (uint256 bidFee, uint256 askFee)
    {
        ...
        // calm:   [470, 540, 620]
        // stress: [620, 550, 460]
        slots[8] = 500 | (560 << 16) | (600 << 32);
        slots[9] = 650 | (560 << 16) | (430 << 32);
