...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant RB_STRESS_DECAY_PCT = 78;
    uint256 private constant RB_STRESS_CAP_BPS = 220;
    uint256 private constant RB_SHOCK_CAP_BPS = 160;
    uint256 private constant RB_SHOCK_HARD_BPS = 66;
    ...
    uint256 private constant RB_LOSS_TRIGGER_BPS = 6;
    uint256 private constant RB_LOSS_BONUS_CAP_BPS = 60;
    uint256 private constant RB_REPLAY_STEPS = 3;
    uint256 private constant RB_REPLAY_BONUS_BPS = 14;

    uint256 private constant RB_UNCERT_DECAY_PCT = 82;
    uint256 private constant RB_UNCERT_CAP_BPS = 260;
    uint256 private constant RB_UNCERT_STRESS_WEIGHT_PCT = 65;
    uint256 private constant RB_UNCERT_CONF_WEIGHT_PCT = 35;
    uint256 private constant RB_UNCERT_ENTER_BPS = 118;
    uint256 private constant RB_UNCERT_EXIT_BPS = 50;
    uint256 private constant RB_STRESS_ENTER_BPS = 124;
    uint256 private constant RB_HOLD_STEPS = 2;

    uint256 private constant RB_SAFE_TIGHT_ADD_BPS = 2;
    uint256 private constant RB_SAFE_BUFFER_ADD_CENTI_BPS = 45;
    uint256 private constant RB_SAFE_COMP_CUT_CENTI_BPS = 20;
    uint256 private constant RB_FALLBACK_FEE_CENTI_BPS = 2968;
    uint256 private constant RB_FALLBACK_MIS_MAX_BPS = 30;
