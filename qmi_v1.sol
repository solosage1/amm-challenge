...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MICRO_ALPHA_PCT = 0;
    uint256 private constant MICRO_DECAY_PCT = 95;
    uint256 private constant MICRO_MOVE_CAP_BPS = 20;
    uint256 private constant MICRO_DEADBAND_BPS = 999;
    uint256 private constant MICRO_TILT_DIV = 1;
    uint256 private constant MICRO_MAX_TILT_BPS = 0;
    ...
    uint256 private constant SIGNAL_FLOW_W_PCT = 100;
    uint256 private constant SIGNAL_MICRO_W_PCT = 0;
    uint256 private constant SIGNAL_QUEUE_W_PCT = 0;
    uint256 private constant EXTRA_TILT_MAX_BPS = 0;

    uint256 private constant WIDE_SIGNAL_DIV = 1;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = 0;
    uint256 private constant WIDE_COMP_BONUS_PCT = 0;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = 0;
