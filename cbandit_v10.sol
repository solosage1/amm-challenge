...
contract Strategy is AMMStrategyBase {
    ...
    // Bandit controls.
    uint256 private constant EXPLORE_MILLI = 150000;
    uint256 private constant STICKY_BONUS_MILLI = 11000;
    uint256 private constant BANDIT_COUNT_CAP = 650;
    uint256 private constant BANDIT_DECAY_PCT = 92;

    // Reward shaping.
    uint256 private constant POS_EDGE_BPS = 2;
    uint256 private constant NEG_EDGE_BPS = 3;
    uint256 private constant QUALITY_MIS_BPS = 28;

    // Context thresholds.
    uint256 private constant CALM_MIS_BPS = 27;
    uint256 private constant CALM_VOL_BPS = 19;
    uint256 private constant CALM_SIZE_BPS = 75;
    uint256 private constant STRESS_MIS_BPS = 74;
    uint256 private constant STRESS_VOL_BPS = 60;
    uint256 private constant STRESS_SIZE_BPS = 165;

    // Context-specific nudges.
    uint256 private constant CALM_UNDERCUT_ADD_CENTI_BPS = 90;
    uint256 private constant CALM_BUFFER_CUT_CENTI_BPS = 20;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 170;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 55;
    ...
    uint256 private constant ARM1_UNDERCUT_CENTI_BPS = 980;
    uint256 private constant ARM1_BUFFER_CENTI_BPS = 45;

    uint256 private constant ARM2_BAND_BPS = 30;
    uint256 private constant ARM2_TIGHT_CENTI_BPS = 2720;
    uint256 private constant ARM2_UNDERCUT_CENTI_BPS = 1200;
    uint256 private constant ARM2_BUFFER_CENTI_BPS = 0;

    uint256 private constant ARM3_BAND_BPS = 34;
    uint256 private constant ARM3_TIGHT_CENTI_BPS = 2660;
    uint256 private constant ARM3_UNDERCUT_CENTI_BPS = 1360;
    ...
    uint256 private constant CALM_BIAS_ARM3_MILLI = 23000;

    uint256 private constant NORMAL_BIAS_ARM1_MILLI = 13000;
    uint256 private constant NORMAL_BIAS_ARM2_MILLI = 4000;

    uint256 private constant STRESS_BIAS_ARM0_MILLI = 24000;
