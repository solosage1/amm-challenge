...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_ENTER_BPS = 130;
    uint256 private constant STRESS_EXIT_BPS = 100;

    uint256 private constant AMBIGUITY_PCT = 12;
    uint256 private constant VOL_WEIGHT_PCT = 6;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 6;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 7;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 70;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 15;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 4;
    uint256 private constant STRESS_BAND_CUT_BPS = 0;

    uint256 private constant PANIC_SCORE_BPS = 170;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 8;
