...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = 22;
    uint256 private constant ARB_CLASS_SIZE_BPS = 10;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = 3000;

    uint256 private constant ARB_CONF_DECAY_PCT = 90;
    uint256 private constant ARB_CONF_HIT_BPS = 3800;
    uint256 private constant ARB_CONF_MISS_BPS = 700;

    uint256 private constant ARB_ALPHA_PCT = 32;
    uint256 private constant RETAIL_ALPHA_PCT = 10;
    uint256 private constant RETAIL_INV_W_PCT = 45;

    uint256 private constant ARB_JUMP_BPS = 700;
    uint256 private constant RETAIL_JUMP_BPS = 220;

    uint256 private constant CONF_GATE_BPS = 5000;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = 2;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = 220;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = 150;
    uint256 private constant CONF_POST_ARB_ADD_BPS = 2;
