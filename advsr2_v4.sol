...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CP_FLIP_BONUS_BPS = 10;
    uint256 private constant CP_TOWARD_BONUS_BPS = 14;
    uint256 private constant CP_SIGNAL_CAP_BPS = 220;
    uint256 private constant CP_ALPHA_PCT = 9;
    uint256 private constant CP_DECAY_PCT = 91;
    uint256 private constant CP_REPLAY_WINDOW = 2;
    uint256 private constant CP_REPLAY_SIGNAL_FLOOR_BPS = 32;
    uint256 private constant CP_REPLAY_BONUS_BPS = 6;

    // Stress mode hysteresis.
    uint256 private constant STRESS_ENTER_BPS = 50;
    uint256 private constant STRESS_EXIT_BPS = 25;
    uint256 private constant STRESS_INSTANT_BPS = 85;
    uint256 private constant STRESS_MIN_HOLD_STEPS = 2;

    // Stress-mode spread/undercut clamps.
    uint256 private constant STRESS_TIGHT_ADD_BPS = 1;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 8;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 80;
    uint256 private constant STRESS_COMP_FLOOR_BPS = 0;
    uint256 private constant STRESS_MAX_SPREAD_BPS = 1000;
    uint256 private constant STRESS_POST_ARB_CUT_SCALE_PCT = 85;
