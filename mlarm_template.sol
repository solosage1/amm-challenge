...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARM0_BAND_BPS = __ARM0_BAND__;
    uint256 private constant ARM1_BAND_BPS = __ARM1_BAND__;
    uint256 private constant ARM2_BAND_BPS = __ARM2_BAND__;

    uint256 private constant ARM0_TIGHT_CENTI_BPS = __ARM0_TIGHT__;
    uint256 private constant ARM1_TIGHT_CENTI_BPS = __ARM1_TIGHT__;
    uint256 private constant ARM2_TIGHT_CENTI_BPS = __ARM2_TIGHT__;

    uint256 private constant ARM0_UNDERCUT_CENTI_BPS = __ARM0_UNDER__;
    uint256 private constant ARM1_UNDERCUT_CENTI_BPS = __ARM1_UNDER__;
    uint256 private constant ARM2_UNDERCUT_CENTI_BPS = __ARM2_UNDER__;

    uint256 private constant ARM0_BUFFER_CENTI_BPS = __ARM0_BUFFER__;
    uint256 private constant ARM1_BUFFER_CENTI_BPS = __ARM1_BUFFER__;
    uint256 private constant ARM2_BUFFER_CENTI_BPS = __ARM2_BUFFER__;
    ...
    uint256 private constant WIDE_SIGNAL_DIV = __WIDE_DIV__;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = __WIDE_MAX__;
    uint256 private constant WIDE_COMP_BONUS_PCT = __WIDE_COMP__;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = __WIDE_PROTECT__;

    // Meta-learning / gating.
    uint256 private constant META_AGGR_ALPHA_PCT = __META_AGGR_ALPHA__;
    uint256 private constant META_RISK_ALPHA_PCT = __META_RISK_ALPHA__;
    uint256 private constant META_MAG_CAP_BPS = __META_MAG_CAP__;
    uint256 private constant META_CLAMP_BPS = __META_CLAMP__;

    uint256 private constant RISK_ARM_TRIG_BPS = __RISK_TRIG__;
    uint256 private constant AGGR_ARM_TRIG_BPS = __AGGR_TRIG__;
    uint256 private constant AGGR_MAX_RISK_BPS = __AGGR_MAX_RISK__;

    uint256 private constant CONF_GATE_BPS = __CONF_GATE__;
    uint256 private constant CONF_UP_BPS = __CONF_UP__;
    uint256 private constant CONF_DOWN_BPS = __CONF_DOWN__;
    uint256 private constant CONF_MISS_BPS = __CONF_MISS__;
