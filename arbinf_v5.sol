...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = 18;
    uint256 private constant ARB_CLASS_SIZE_BPS = 7;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = 4000;

    uint256 private constant ARB_CONF_DECAY_PCT = 87;
    uint256 private constant ARB_CONF_HIT_BPS = 3000;
    uint256 private constant ARB_CONF_MISS_BPS = 500;

    uint256 private constant ARB_ALPHA_PCT = 27;
    uint256 private constant RETAIL_ALPHA_PCT = 12;
    uint256 private constant RETAIL_INV_W_PCT = 52;

    uint256 private constant ARB_JUMP_BPS = 600;
    uint256 private constant RETAIL_JUMP_BPS = 250;

    uint256 private constant CONF_GATE_BPS = 4000;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = 2;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = 180;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = 90;
