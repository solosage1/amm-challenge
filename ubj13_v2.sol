...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_ALPHA_PCT = 16;
    uint256 private constant INV_DEADBAND_BPS = 10;
    uint256 private constant INV_DIV = 7;
    uint256 private constant INV_MAX_BPS = 3;

    uint256 private constant SKEW_ALPHA_PCT = 18;
    uint256 private constant SKEW_DEADBAND_BPS = 8;
    uint256 private constant SKEW_DIV = 7;
    uint256 private constant SKEW_MAX_BPS = 3;
    uint256 private constant SKEW_STREAK_BONUS_BPS = 1;

    uint256 private constant BIAS_ENTER_BPS = 4;
    uint256 private constant BIAS_FLIP_BPS = 8;
    uint256 private constant BIAS_HOLD_STEPS = 1;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 50;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 60;
