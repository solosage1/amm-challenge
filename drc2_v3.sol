...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_ENTER_BPS = 100;
    uint256 private constant STRESS_EXIT_BPS = 74;

    uint256 private constant AMBIGUITY_PCT = 20;
    uint256 private constant VOL_WEIGHT_PCT = 10;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 10;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 5;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 110;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 40;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 10;
    uint256 private constant STRESS_BAND_CUT_BPS = 1;

    uint256 private constant PANIC_SCORE_BPS = 140;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 15;
