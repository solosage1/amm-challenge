...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MICRO_DECAY_PCT = 97;
    uint256 private constant MICRO_MOVE_CAP_BPS = 50;
    ...
    uint256 private constant QUEUE_ALPHA_PCT = 20;
    uint256 private constant QUEUE_DECAY_PCT = 94;
    uint256 private constant QUEUE_TRIGGER = 3;
    uint256 private constant QUEUE_STEP_BPS = 1;
    uint256 private constant QUEUE_MAX_BPS = 4;
    uint256 private constant QUEUE_DEADBAND_BPS = 2;
    uint256 private constant QUEUE_TILT_DIV = 4;
    uint256 private constant QUEUE_MAX_TILT_BPS = 1;
    uint256 private constant QUEUE_GAP_RESET = 2;

    uint256 private constant SIGNAL_FLOW_W_PCT = 60;
    uint256 private constant SIGNAL_MICRO_W_PCT = 30;
    uint256 private constant SIGNAL_QUEUE_W_PCT = 10;
    uint256 private constant EXTRA_TILT_MAX_BPS = 2;

    uint256 private constant WIDE_SIGNAL_DIV = 9;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = 7;
    uint256 private constant WIDE_COMP_BONUS_PCT = 100;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = 80;
