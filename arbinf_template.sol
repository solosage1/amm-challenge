...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = __AC_MIS__;
    uint256 private constant ARB_CLASS_SIZE_BPS = __AC_SIZE__;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = __AC_TOL__;

    uint256 private constant ARB_CONF_DECAY_PCT = __CONF_DECAY__;
    uint256 private constant ARB_CONF_HIT_BPS = __CONF_HIT__;
    uint256 private constant ARB_CONF_MISS_BPS = __CONF_MISS__;

    uint256 private constant ARB_ALPHA_PCT = __ARB_ALPHA__;
    uint256 private constant RETAIL_ALPHA_PCT = __RET_ALPHA__;
    uint256 private constant RETAIL_INV_W_PCT = __RET_INV_W__;

    uint256 private constant ARB_JUMP_BPS = __ARB_JUMP__;
    uint256 private constant RETAIL_JUMP_BPS = __RET_JUMP__;

    uint256 private constant CONF_GATE_BPS = __CONF_GATE__;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = __CONF_BAND_CUT__;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = __CONF_UNDER_ADD__;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = __CONF_BUF_CUT__;
    uint256 private constant CONF_POST_ARB_ADD_BPS = __CONF_POST_ADD__;
