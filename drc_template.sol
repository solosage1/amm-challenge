...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant EWMA_LOSS_NEW_PCT = __EWMA_LOSS_NEW_PCT__;
    uint256 private constant EWMA_TAIL_NEW_PCT = __EWMA_TAIL_NEW_PCT__;
    ...
    uint256 private constant AMBIGUITY_PCT = __AMBIGUITY_PCT__;
    uint256 private constant VOL_WEIGHT_PCT = __VOL_WEIGHT_PCT__;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = __ADV_REPLAY_WEIGHT_PCT__;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = __CVAR_TAIL_TRIGGER_BPS__;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = __CVAR_TAIL_WEIGHT_PCT__;
    ...
    uint256 private constant PANIC_SCORE_BPS = __PANIC_SCORE_BPS__;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = __PANIC_BUFFER_ADD_CENTI_BPS__;
