...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARB_CLASS_MIS_BPS = 19;
    uint256 private constant ARB_CLASS_SIZE_BPS = 7;
    uint256 private constant ARB_CLASS_RATIO_TOL_BPS = 3800;

    uint256 private constant ARB_CONF_DECAY_PCT = 88;
    uint256 private constant ARB_CONF_HIT_BPS = 3400;
    uint256 private constant ARB_CONF_MISS_BPS = 550;

    uint256 private constant ARB_ALPHA_PCT = 30;
    uint256 private constant RETAIL_ALPHA_PCT = 11;
    uint256 private constant RETAIL_INV_W_PCT = 50;

    uint256 private constant ARB_JUMP_BPS = 620;
    uint256 private constant RETAIL_JUMP_BPS = 240;

    uint256 private constant CONF_GATE_BPS = 4400;
    uint256 private constant CONF_TIGHT_BAND_CUT_BPS = 1;
    uint256 private constant CONF_UNDERCUT_ADD_CENTI_BPS = 190;
    uint256 private constant CONF_BUFFER_CUT_CENTI_BPS = 120;
