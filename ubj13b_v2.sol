...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_DEADBAND_BPS = 10;
    uint256 private constant INV_DIV = 8;
    uint256 private constant INV_MAX_BPS = 2;

    uint256 private constant STREAK_ENTER = 3;
    uint256 private constant STREAK_FLIP_BPS = 3;
    uint256 private constant STREAK_BONUS_MAX_BPS = 2;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 50;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 50;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 15;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 55;
