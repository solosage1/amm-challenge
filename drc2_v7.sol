...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_ENTER_BPS = 105;
    uint256 private constant STRESS_EXIT_BPS = 78;

    uint256 private constant AMBIGUITY_PCT = 18;
    uint256 private constant VOL_WEIGHT_PCT = 8;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 9;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 5;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 100;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 35;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 9;
    uint256 private constant STRESS_BAND_CUT_BPS = 0;

    uint256 private constant PANIC_SCORE_BPS = 145;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 14;
