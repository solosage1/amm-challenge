...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant CP_JUMP_W_PCT = 65;
    uint256 private constant CP_MIS_W_PCT = 35;
    uint256 private constant CP_FLIP_BONUS_BPS = 30;
    uint256 private constant CP_TOWARD_BONUS_BPS = 26;
    uint256 private constant CP_SIGNAL_CAP_BPS = 210;
    uint256 private constant CP_ALPHA_PCT = 18;
    uint256 private constant CP_DECAY_PCT = 82;
    uint256 private constant CP_REPLAY_WINDOW = 5;
    uint256 private constant CP_REPLAY_SIGNAL_FLOOR_BPS = 18;
    uint256 private constant CP_REPLAY_BONUS_BPS = 30;

    // Stress mode hysteresis.
    uint256 private constant STRESS_ENTER_BPS = 30;
    uint256 private constant STRESS_EXIT_BPS = 14;
    uint256 private constant STRESS_INSTANT_BPS = 50;
    uint256 private constant STRESS_MIN_HOLD_STEPS = 6;

    // Stress-mode spread/undercut clamps.
    uint256 private constant STRESS_TIGHT_ADD_BPS = 3;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 36;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 360;
    uint256 private constant STRESS_COMP_FLOOR_BPS = 24;
    uint256 private constant STRESS_MAX_SPREAD_BPS = 48;
    uint256 private constant STRESS_POST_ARB_CUT_SCALE_PCT = 20;
