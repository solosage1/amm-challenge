...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_DEADBAND_BPS = 8;
    uint256 private constant INV_DIV = 6;
    uint256 private constant INV_MAX_BPS = 5;

    uint256 private constant STREAK_ENTER = 3;
    uint256 private constant STREAK_FLIP_BPS = 5;
    uint256 private constant STREAK_BONUS_MAX_BPS = 4;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 75;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 35;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 15;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 80;
    uint256 private constant BIAS_COMP_MAX_BPS = 4;
