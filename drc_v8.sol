...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant EWMA_LOSS_NEW_PCT = 16;
    uint256 private constant EWMA_TAIL_NEW_PCT = 20;

    uint256 private constant STRESS_ENTER_BPS = 52;
    uint256 private constant STRESS_EXIT_BPS = 32;

    uint256 private constant AMBIGUITY_PCT = 60;
    uint256 private constant VOL_WEIGHT_PCT = 30;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 55;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 2;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 200;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 260;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 75;
    uint256 private constant STRESS_BAND_CUT_BPS = 2;

    uint256 private constant PANIC_SCORE_BPS = 76;
    uint256 private constant PANIC_BUFFER_ADD_CENTI_BPS = 95;
