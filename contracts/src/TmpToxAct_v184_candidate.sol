...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_009","confidence":0.64,"ceiling_probability":0.28,"ev_next_5":0.09,"best_delta_seen":2.3074,"reason":"Tighten the joint activity gate by raising lambda threshold so activity widening triggers less in calm flow while preserving busy-flow defense.","next_mechanism":"toxicity_and_activity"}
    ...
    uint256 constant ACT_GATE_LAMBDA = 1000000000000000000;
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v184";
    }
}
