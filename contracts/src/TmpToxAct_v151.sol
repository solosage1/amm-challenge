...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_004","confidence":0.64,"ceiling_probability":0.31,"ev_next_5":0.15,"best_delta_seen":0.15,"reason":"Test lower tox blend alpha near 0.20 to reduce fee churn while preserving toxicity response.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v151";
    }
}
