...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_009","confidence":0.66,"ceiling_probability":0.27,"ev_next_5":0.10,"best_delta_seen":2.3074,"reason":"Tighten the joint lambda-and-size activity gate with a modestly higher size threshold to reduce false calm-period widening while preserving busy-flow defense.","next_mechanism":"toxicity_and_activity"}
    ...
    uint256 constant ACT_GATE_SIZE = 3500000000000000;
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v202";
    }
}
