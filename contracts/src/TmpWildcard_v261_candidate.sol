...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_007","confidence":0.67,"ceiling_probability":0.29,"ev_next_5":0.06,"best_delta_seen":2.3074,"reason":"promotion_edge 519.26 with T3 dual-objective wildcard; bounded fees, coherent spread behavior, and no pathological liquidity collapse","next_mechanism":"wildcard"}
    ...
    uint256 constant SIGNAL_THRESHOLD = WAD / 800;
    ...
    uint256 constant SIZE_DECAY = 680000000000000000;
    uint256 constant TOX_FAST_DECAY = 820000000000000000;
    ...
    uint256 constant REF_ALPHA_ARB_FIRST = 260000000000000000;
    uint256 constant REF_ALPHA_RETAIL_FIRST = 130000000000000000;
    uint256 constant REF_ALPHA_FOLLOW = 70000000000000000;
    uint256 constant SHOCK_GATE = 28 * BPS;
    uint256 constant SHOCK_DAMP = 300000000000000000;
    uint256 constant SIGMA_ALPHA_FIRST = 240000000000000000;
    uint256 constant SIGMA_ALPHA_FOLLOW = 90000000000000000;
    uint256 constant TOX_FAST_ALPHA = 240000000000000000;
    uint256 constant TOX_SLOW_ALPHA_FIRST = 130000000000000000;
    uint256 constant TOX_SLOW_ALPHA_FOLLOW = 90000000000000000;
    uint256 constant ACT_ALPHA_FIRST = 160000000000000000;
    uint256 constant ACT_ALPHA_FOLLOW = 90000000000000000;
    uint256 constant SIZE_ALPHA_FIRST = 200000000000000000;
    uint256 constant SIZE_ALPHA_FOLLOW = 120000000000000000;
    uint256 constant CONF_ALPHA = 180000000000000000;
    uint256 constant CONF_NEUTRAL = 720000000000000000;

    uint256 constant DIR_PUSH_MULT = 2;
    uint256 constant DIR_PUSH_CAP = WAD / 4;

    uint256 constant BASE_FEE = 3 * BPS;
    uint256 constant SIGMA_COEF = 180000000000000000;
    uint256 constant LAMBDA_COEF = 10 * BPS;
    uint256 constant FLOW_COEF = 6600 * BPS;
    uint256 constant TOX_COEF = 190 * BPS;
    uint256 constant TOX_QUAD_COEF = 16000 * BPS;
    uint256 constant TOX_KNEE = 12 * BPS;
    uint256 constant TOX_QUAD_CAP = 300 * BPS;
    uint256 constant STRESS_GUARD_COEF = 140 * BPS;
    uint256 constant CONF_GUARD_COEF = 130 * BPS;
    uint256 constant CONF_RELIEF_COEF = 90 * BPS;

    uint256 constant MID_FLOOR = 2 * BPS;
    uint256 constant MID_UP_CAP_HARD = 110 * BPS;
    uint256 constant MID_DOWN_CAP_HARD = 150 * BPS;
    uint256 constant MID_UP_CAP_SOFT = 60 * BPS;
    uint256 constant MID_DOWN_CAP_SOFT = 80 * BPS;

    uint256 constant SPREAD_BASE = 8 * BPS;
    uint256 constant SPREAD_STRESS_COEF = 180 * BPS;
    uint256 constant SPREAD_TOX_COEF = 130 * BPS;
    uint256 constant SPREAD_FLOW_COEF = 140 * BPS;
    uint256 constant SPREAD_RET_COEF = 120 * BPS;
    uint256 constant SPREAD_ACT_COEF = 120 * BPS;
    uint256 constant SPREAD_CONF_RELIEF_COEF = 90 * BPS;
    uint256 constant SPREAD_MIN = 4 * BPS;
    uint256 constant SPREAD_MAX = 200 * BPS;
    uint256 constant SPREAD_UP_CAP_HARD = 120 * BPS;
    uint256 constant SPREAD_DOWN_CAP_HARD = 140 * BPS;
    uint256 constant SPREAD_UP_CAP_SOFT = 60 * BPS;
    uint256 constant SPREAD_DOWN_CAP_SOFT = 80 * BPS;
    uint256 constant FIRST_REVEAL_SPREAD_ADD = 18 * BPS;
    uint256 constant FIRST_REVEAL_MID_ADD = 12 * BPS;
    uint256 constant MULTI_SIGNAL_SPREAD_ADD = 20 * BPS;
    uint256 constant MULTI_SIGNAL_MID_ADD = 14 * BPS;

    uint256 constant AGREE_TOX_GATE = 9 * BPS;
    uint256 constant AGREE_SIGMA_GATE = 8 * BPS;
    uint256 constant AGREE_FLOW_GATE = 1100000000000000;
    uint256 constant AGREE_GAP_GATE = 4 * BPS;
    uint256 constant RET_DEADBAND = 6 * BPS;

    uint256 constant DIR_COEF = 90 * BPS;
    uint256 constant DIR_STRESS_COEF = 30 * BPS;
    uint256 constant SKEW_CAP = 150 * BPS;

    uint256 constant VULN_TOX_COEF = 170 * BPS;
    uint256 constant VULN_STRESS_COEF = 200 * BPS;
    ...
    uint256 constant LIQUIDITY_CEIL_STRESS = 1200 * BPS;

    uint256 constant STRESS_TOX_W = 2100000000000000000;
    uint256 constant STRESS_VOL_W = 1400000000000000000;
    uint256 constant STRESS_FLOW_W = 900000000000000000;
    uint256 constant STRESS_GAP_W = 1200000000000000000;
    uint256 constant STRESS_CONF_W = 800000000000000000;
    uint256 constant STRESS_RET_W = 700000000000000000;
    uint256 constant STRESS_ACT_W = 600000000000000000;

    uint256 constant CONF_TOX_W = 2100000000000000000;
    uint256 constant CONF_VOL_W = 1200000000000000000;
    uint256 constant CONF_FLOW_W = 900000000000000000;
    uint256 constant CONF_GAP_W = 1000000000000000000;
    uint256 constant CONF_ACT_W = 700000000000000000;
    uint256 constant CONF_RET_W = 800000000000000000;
    ...
    function afterInitialize(uint256 initialX, uint256 initialY) external override returns (uint256, uint256) {
        ...
        slots[3] = p0;
        slots[4] = 9 * BPS;
        slots[5] = 820000000000000000;
        slots[6] = 2000000000000000;
        slots[7] = 0;
        slots[8] = 0;
        slots[9] = 0;
        slots[10] = WAD;
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256, uint256) {
        ...
        _updateReferenceVol(s, r.pImplied, r.ret, r.firstInStep, r.likelyArb);
        ...
        uint256 midTarget = _computeMidTarget(s, r.flowPressure, r.stress, r.firstInStep, r.agree);
    ...
    function _updateReferenceVol(State memory s, uint256 pImplied, uint256 ret, bool firstInStep, bool likelyArb)
        internal
        pure
    {
        uint256 alpha;
        ...
        if (firstInStep) {
            alpha = likelyArb ? REF_ALPHA_ARB_FIRST : REF_ALPHA_RETAIL_FIRST;
            sigmaAlpha = SIGMA_ALPHA_FIRST;
            sigmaInput = ret;
        } else {
            alpha = REF_ALPHA_FOLLOW;
        ...
        returns (uint256 flowPressure, uint256 toxGap, uint256 stress)
    {
        ...
        uint256 confPenalty =
            wmul(CONF_TOX_W, s.toxSlow)
            + wmul(CONF_VOL_W, s.sigmaHat)
            + wmul(CONF_FLOW_W, flowPressure)
            + wmul(CONF_GAP_W, toxGap)
            + wmul(CONF_ACT_W, s.actEma);
        ...
        stress = _computeStress(s, flowPressure, toxGap, firstInStep ? ret : ret / 3);
    }
    ...
    {
        stress =
            wmul(STRESS_TOX_W, s.toxSlow)
            + wmul(STRESS_VOL_W, s.sigmaHat)
            + wmul(STRESS_FLOW_W, flowPressure)
            + wmul(STRESS_GAP_W, toxGap)
            + wmul(STRESS_CONF_W, WAD - s.confEma)
            + wmul(STRESS_RET_W, retTerm)
            + wmul(STRESS_ACT_W, s.actEma);
        ...
        returns (bool)
    {
        return
            s.toxSlow >= AGREE_TOX_GATE && s.sigmaHat >= AGREE_SIGMA_GATE && flowPressure >= AGREE_FLOW_GATE
                && (ret >= RET_DEADBAND || toxGap >= AGREE_GAP_GATE);
    }

    function _computeMidTarget(State memory s, uint256 flowPressure, uint256 stress, bool firstInStep, bool agree)
        internal
        pure
        returns (uint256 midTarget)
    {
        ...
        midTarget = midTarget + wmul(CONF_GUARD_COEF, WAD - s.confEma);

        if (firstInStep && s.toxFast > AGREE_TOX_GATE) midTarget = midTarget + FIRST_REVEAL_MID_ADD;
        if (agree) midTarget = midTarget + MULTI_SIGNAL_MID_ADD;
    ...
    function _computeSpreadTarget(
        ...
        if (agree) spreadTarget = spreadTarget + MULTI_SIGNAL_SPREAD_ADD;
    ...
    function _enforceCoherence(uint256 bidFee, uint256 askFee, uint256 stress) internal pure returns (uint256, uint256) {
        if (bidFee > askFee) {
            uint256 diff1 = bidFee - askFee;
            if (diff1 > MAX_SIDE_DIFF) {
                uint256 cut1 = diff1 - MAX_SIDE_DIFF;
                bidFee = bidFee > cut1 ? bidFee - cut1 : 0;
            }
        } else {
            uint256 diff2 = askFee - bidFee;
            if (diff2 > MAX_SIDE_DIFF) {
                uint256 cut2 = diff2 - MAX_SIDE_DIFF;
                askFee = askFee > cut2 ? askFee - cut2 : 0;
            }
        }
