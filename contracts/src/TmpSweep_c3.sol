...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TAIL_TRANSITION = 50 * BPS;
    uint256 constant TAIL_SLOPE_PROTECT = 920000000000000000;
    uint256 constant TAIL_SLOPE_ATTRACT = 760000000000000000;
    uint256 constant TAIL_MAX_EFFECTIVE_PROTECT = 760 * BPS;
    uint256 constant TAIL_MAX_EFFECTIVE_ATTRACT = 460 * BPS;
