...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_002","confidence":0.63,"ceiling_probability":0.27,"ev_next_5":0.09,"best_delta_seen":0.15,"reason":"Highest eff_priority (0.936); concrete new lever despite soft_nochange is raising TOX_QUAD_KNEE so convex tox widening activates later in calm flow.","next_mechanism":"toxicity_and_activity"}
    ...
    uint256 constant TOX_QUAD_KNEE = 20 * BPS;
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v224";
    }
}
