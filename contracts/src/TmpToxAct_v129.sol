...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_004","confidence":0.57,"ceiling_probability":0.44,"ev_next_5":0.03,"best_delta_seen":-0.0396,"reason":"Explore lower-churn tox EWMA by reducing current-tox weight to ~0.20 while keeping the rest of tox/activity logic unchanged.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v129";
    }
}
