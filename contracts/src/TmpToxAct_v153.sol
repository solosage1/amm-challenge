...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_004","confidence":0.68,"ceiling_probability":0.33,"ev_next_5":0.12,"best_delta_seen":0.15,"reason":"Test slower tox EWMA update (alpha~0.20) to reduce fee churn and stale overreaction while preserving existing convex tox penalties.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v153";
    }
}
