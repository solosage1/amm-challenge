...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_011","confidence":0.66,"ceiling_probability":0.24,"ev_next_5":0.026,"best_delta_seen":2.3074,"reason":"Selected H_TOX_ACT_011 on eff_priority 0.788 with promotion_edge 519.30; T4 calibrates adverse tox/activity widening by likelyArb state to target arb share <0.22.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v280";
    }
}
