...
contract Strategy is AMMStrategyBase {
    uint256 constant TAIL_KNEE = 140 * BPS;
    uint256 constant TAIL_TRANSITION = 40 * BPS;
    uint256 constant TAIL_SLOPE_PROTECT = 880000000000000000;
    uint256 constant TAIL_SLOPE_ATTRACT = 720000000000000000;
    uint256 constant TAIL_MAX_EFFECTIVE_PROTECT = 620 * BPS;
    uint256 constant TAIL_MAX_EFFECTIVE_ATTRACT = 360 * BPS;
