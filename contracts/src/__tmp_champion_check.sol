...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_001","confidence":0.74,"ceiling_probability":0.36,"ev_next_5":0.06,"best_delta_seen":2.3074,"reason":"Selected H_TOX_ACT_001: eff_priority 0.724 and recent_mean_delta +0.0201 with promotion_edge 519.26; T2 favors adverse-side defense while preserving favorable-side routing.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v250";
    }
}
