...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"pivot","hypothesis_id":"H_WILDCARD_200","confidence":0.72,"ceiling_probability":0.44,"ev_next_5":0.03,"best_delta_seen":0.15,"reason":"Continuous gated recentering removes first-trade dependence; further gains likely require richer multi-anchor state beyond this lightweight surface.","next_mechanism":"dual_anchor_vol_surface"}
    ...
    uint256 constant ACT_COEF = 44000 * BPS;
