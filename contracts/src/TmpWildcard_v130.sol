...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"pivot","hypothesis_id":"H_WILDCARD_130","confidence":0.71,"ceiling_probability":0.28,"ev_next_5":0.19,"best_delta_seen":0.15,"reason":"Shift to a continuous dual-anchor risk surface with risk-normalized fee rate limits and elastic asymmetric tails to improve edge under mixed toxic and retail flow.","next_mechanism":"dual_anchor_rate_limited_surface"}
    ...
    uint256 constant FLOW_FAST_DECAY = 870000000000000000;
    uint256 constant FLOW_SLOW_DECAY = 950000000000000000;
    uint256 constant ACT_DECAY = 750000000000000000;
    uint256 constant SIZE_DECAY = 700000000000000000;
    uint256 constant TOX_DECAY = 900000000000000000;
    uint256 constant VOL_FAST_DECAY = 740000000000000000;
    uint256 constant VOL_SLOW_DECAY = 940000000000000000;
    uint256 constant IMPACT_DECAY = 880000000000000000;
    ...
    uint256 constant VOL_FAST_BLEND_DECAY = 660000000000000000;
    uint256 constant VOL_SLOW_BLEND_DECAY = 930000000000000000;
    uint256 constant TOX_BLEND_DECAY = 300000000000000000;
    uint256 constant IMPACT_BLEND_DECAY = 560000000000000000;
    ...
    uint256 constant ALPHA_FAST_GAP_COEF = 200000000000000000;
    ...
    uint256 constant ALPHA_SLOW_GAP_COEF = 50000000000000000;
    uint256 constant ALPHA_SLOW_MAX = 90000000000000000;
    uint256 constant ALPHA_DAMP_KNEE = 25000000000000000;
    uint256 constant ALPHA_DAMP_SLOPE = 1600000000000000000;
    ...
    uint256 constant VOL_FAST_COEF = 130000000000000000;
    uint256 constant VOL_SLOW_COEF = 80000000000000000;
    uint256 constant VOL_GAP_COEF = 180000000000000000;
    uint256 constant TOX_COEF = 230 * BPS;
    uint256 constant TOX_QUAD_COEF = 20000 * BPS;
    uint256 constant TOX_KNEE = 10 * BPS;
    uint256 constant IMPACT_COEF = 5200 * BPS;
    uint256 constant IMPACT_QUAD_COEF = 9000 * BPS;
    uint256 constant IMPACT_KNEE = 8 * BPS;
    uint256 constant ACT_COEF = 28000 * BPS;
    uint256 constant SIZE_COEF = 8000 * BPS;
    uint256 constant LAMBDA_COEF = 9 * BPS;
    uint256 constant FLOW_COEF = 4600 * BPS;
    uint256 constant GAP_COEF = 100 * BPS;

    uint256 constant DIR_FAST_WEIGHT = 680000000000000000;
    uint256 constant DIR_COEF = 115 * BPS;
    uint256 constant DIR_TOX_COEF = 40 * BPS;
    uint256 constant DIR_GAP_COEF = 34 * BPS;
    uint256 constant DIR_LEAD_COEF = 50 * BPS;

    uint256 constant STALE_TOX_COEF = 5200 * BPS;
    uint256 constant STALE_GAP_COEF = 85 * BPS;
    uint256 constant STALE_IMPACT_COEF = 2600 * BPS;
    uint256 constant TREND_COEF = 80 * BPS;

    uint256 constant TAIL_KNEE_BASE = 620 * BPS;
    uint256 constant TAIL_KNEE_VOL_COEF = 2100 * BPS;
    uint256 constant TAIL_KNEE_TOX_COEF = 1500 * BPS;
    uint256 constant TAIL_KNEE_GAP_COEF = 1100 * BPS;
    ...
    uint256 constant TAIL_SLOPE_TOX_ADJ = 230000000000000000;
    uint256 constant TAIL_SLOPE_VOL_ADJ = 100000000000000000;
    uint256 constant TAIL_SLOPE_GAP_ADJ = 80000000000000000;
    uint256 constant TAIL_SLOPE_IMPACT_ADJ = 90000000000000000;

    uint256 constant RATE_UP_MIN = 50 * BPS;
    uint256 constant RATE_UP_RISK_RANGE = 160 * BPS;
    uint256 constant RATE_DOWN_MIN = 35 * BPS;
    uint256 constant RATE_DOWN_RISK_RANGE = 145 * BPS;
    ...
    function _riskNorm(State memory s) internal pure returns (uint256 riskNorm) {
        uint256 volGap = s.volFast > s.volSlow ? s.volFast - s.volSlow : 0;
        riskNorm = s.toxEma + s.impactEma + s.gapEma + s.volSlow + (volGap / 2);
