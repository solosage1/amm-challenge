...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_009","confidence":0.63,"ceiling_probability":0.30,"ev_next_5":0.07,"best_delta_seen":2.3074,"reason":"Tighten the joint lambda-and-size activity gate with a higher size threshold to further cut calm-period over-widening while retaining busy-flow defense.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v187";
    }
}
