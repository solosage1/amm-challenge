...
contract Strategy is AMMStrategyBase {
    uint256 constant TAIL_KNEE = 170 * BPS;
    uint256 constant TAIL_TRANSITION = 60 * BPS;
    uint256 constant TAIL_SLOPE_PROTECT = 900000000000000000;
    uint256 constant TAIL_SLOPE_ATTRACT = 700000000000000000;
    uint256 constant TAIL_MAX_EFFECTIVE_PROTECT = 680 * BPS;
    uint256 constant TAIL_MAX_EFFECTIVE_ATTRACT = 380 * BPS;
