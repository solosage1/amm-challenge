...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_004","confidence":0.67,"ceiling_probability":0.34,"ev_next_5":0.12,"best_delta_seen":0.15,"reason":"Test slower tox EWMA blend (effective alpha near 0.20) to reduce fee churn and stale overreaction while preserving existing convex tox widening.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v155";
    }
}
