...
contract Strategy is AMMStrategyBase {
    uint256 constant TAIL_KNEE = 190 * BPS;
    uint256 constant TAIL_TRANSITION = 40 * BPS;
    uint256 constant TAIL_SLOPE_PROTECT = 860000000000000000;
    uint256 constant TAIL_SLOPE_ATTRACT = 680000000000000000;
    uint256 constant TAIL_MAX_EFFECTIVE_PROTECT = 650 * BPS;
    uint256 constant TAIL_MAX_EFFECTIVE_ATTRACT = 350 * BPS;
