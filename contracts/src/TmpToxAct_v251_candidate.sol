...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_001","confidence":0.68,"ceiling_probability":0.34,"ev_next_5":0.05,"best_delta_seen":2.3074,"reason":"eff_priority 0.684 and recent_mean_delta +0.0164 with promotion_edge 519.26; T2 keeps adverse-side defense while trimming favorable tox baseline.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v251";
    }
}
