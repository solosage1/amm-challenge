...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"continue","hypothesis_id":"H_TOX_ACT_004","confidence":0.58,"ceiling_probability":0.27,"ev_next_5":0.11,"best_delta_seen":0.15,"reason":"Untested low-cost tox/activity experiment: slow tox EWMA to reduce churn and stale overreaction while preserving existing fee shape.","next_mechanism":"toxicity_and_activity"}
    ...
    function getName() external pure override returns (string memory) {
        return "toxicity_and_activity_mod_v147";
    }
}
