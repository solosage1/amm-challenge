...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant PHAT_ALPHA_BASE = 185000000000000000;
    uint256 constant PHAT_ALPHA_SIZE_COEF = 620000000000000000;
    uint256 constant PHAT_ALPHA_MAX = 500000000000000000;
    uint256 constant PHAT_DAMP_KNEE = 4 * BPS;
    uint256 constant PHAT_DAMP_SLOPE = 1000000000000000000;
