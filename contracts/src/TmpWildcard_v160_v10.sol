...
contract Strategy is AMMStrategyBase {
    // ITERATION_POLICY {"decision":"pivot","hypothesis_id":"H_WILDCARD_160","confidence":0.77,"ceiling_probability":0.66,"ev_next_5":0.04,"best_delta_seen":0.15,"reason":"Continuous single-anchor variants improved modestly but likely hit a local ceiling; next gains should come from explicit dual-anchor microprice state.","next_mechanism":"dual_anchor_microprice"}
    ...
    uint256 constant SIG_SLOW_COEF = 190000000000000000;
    uint256 constant SIG_GAP_COEF = 360000000000000000;
    ...
    uint256 constant DIR_SIG_COEF = 30 * BPS;
    uint256 constant STALE_DIR_COEF = 6100 * BPS;
    uint256 constant STALE_SIG_COEF = 140 * BPS;
