...
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant PHAT_ALPHA_BASE = 170000000000000000;
    uint256 constant PHAT_ALPHA_SIZE_COEF = 560000000000000000;
    uint256 constant PHAT_ALPHA_MAX = 420000000000000000;
    uint256 constant PHAT_DAMP_KNEE = 4 * BPS;
    uint256 constant PHAT_DAMP_SLOPE = 1200000000000000000;
    ...
    uint256 constant TOX_COEF = 185 * BPS;
    ...
    uint256 constant STALE_SIG_COEF = 85 * BPS;
