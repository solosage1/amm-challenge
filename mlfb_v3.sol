...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant RB_STRESS_DECAY_PCT = 80;
    uint256 private constant RB_STRESS_CAP_BPS = 220;
    uint256 private constant RB_SHOCK_CAP_BPS = 160;
    uint256 private constant RB_SHOCK_HARD_BPS = 68;
    ...
    uint256 private constant RB_LOSS_TRIGGER_BPS = 7;
    uint256 private constant RB_LOSS_BONUS_CAP_BPS = 60;
    uint256 private constant RB_REPLAY_STEPS = 3;
    uint256 private constant RB_REPLAY_BONUS_BPS = 12;

    uint256 private constant RB_UNCERT_DECAY_PCT = 82;
    uint256 private constant RB_UNCERT_CAP_BPS = 260;
    uint256 private constant RB_UNCERT_STRESS_WEIGHT_PCT = 60;
    uint256 private constant RB_UNCERT_CONF_WEIGHT_PCT = 40;
    uint256 private constant RB_UNCERT_ENTER_BPS = 112;
    uint256 private constant RB_UNCERT_EXIT_BPS = 48;
    uint256 private constant RB_STRESS_ENTER_BPS = 118;
    uint256 private constant RB_HOLD_STEPS = 2;

    uint256 private constant RB_SAFE_TIGHT_ADD_BPS = 2;
    uint256 private constant RB_SAFE_BUFFER_ADD_CENTI_BPS = 35;
    uint256 private constant RB_SAFE_COMP_CUT_CENTI_BPS = 15;
    uint256 private constant RB_FALLBACK_FEE_CENTI_BPS = 2970;
    uint256 private constant RB_FALLBACK_MIS_MAX_BPS = 28;
