...
contract Strategy is AMMStrategyBase {
    ...
    // Bandit controls.
    uint256 private constant EXPLORE_MILLI = __EXPLORE_MILLI__;
    uint256 private constant STICKY_BONUS_MILLI = __STICKY_BONUS_MILLI__;
    uint256 private constant BANDIT_COUNT_CAP = __BANDIT_COUNT_CAP__;
    uint256 private constant BANDIT_DECAY_PCT = __BANDIT_DECAY_PCT__;

    // Reward shaping.
    uint256 private constant POS_EDGE_BPS = __POS_EDGE_BPS__;
    uint256 private constant NEG_EDGE_BPS = __NEG_EDGE_BPS__;
    uint256 private constant QUALITY_MIS_BPS = __QUALITY_MIS_BPS__;

    // Context thresholds.
    uint256 private constant CALM_MIS_BPS = __CALM_MIS_BPS__;
    uint256 private constant CALM_VOL_BPS = __CALM_VOL_BPS__;
    uint256 private constant CALM_SIZE_BPS = __CALM_SIZE_BPS__;
    uint256 private constant STRESS_MIS_BPS = __STRESS_MIS_BPS__;
    uint256 private constant STRESS_VOL_BPS = __STRESS_VOL_BPS__;
    uint256 private constant STRESS_SIZE_BPS = __STRESS_SIZE_BPS__;

    // Context-specific nudges.
    uint256 private constant CALM_UNDERCUT_ADD_CENTI_BPS = __CALM_UNDERCUT_ADD_CENTI_BPS__;
    uint256 private constant CALM_BUFFER_CUT_CENTI_BPS = __CALM_BUFFER_CUT_CENTI_BPS__;
    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = __STRESS_UNDERCUT_CUT_CENTI_BPS__;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = __STRESS_BUFFER_ADD_CENTI_BPS__;
    uint256 private constant STRESS_BAND_CUT_BPS = __STRESS_BAND_CUT_BPS__;

    // Arm parameters: (tightBandBps, tightFeeCentiBps, undercutCentiBps, bufferCentiBps)
    uint256 private constant ARM0_BAND_BPS = __ARM0_BAND_BPS__;
    uint256 private constant ARM0_TIGHT_CENTI_BPS = __ARM0_TIGHT_CENTI_BPS__;
    uint256 private constant ARM0_UNDERCUT_CENTI_BPS = __ARM0_UNDERCUT_CENTI_BPS__;
    uint256 private constant ARM0_BUFFER_CENTI_BPS = __ARM0_BUFFER_CENTI_BPS__;

    uint256 private constant ARM1_BAND_BPS = __ARM1_BAND_BPS__;
    uint256 private constant ARM1_TIGHT_CENTI_BPS = __ARM1_TIGHT_CENTI_BPS__;
    uint256 private constant ARM1_UNDERCUT_CENTI_BPS = __ARM1_UNDERCUT_CENTI_BPS__;
    uint256 private constant ARM1_BUFFER_CENTI_BPS = __ARM1_BUFFER_CENTI_BPS__;

    uint256 private constant ARM2_BAND_BPS = __ARM2_BAND_BPS__;
    uint256 private constant ARM2_TIGHT_CENTI_BPS = __ARM2_TIGHT_CENTI_BPS__;
    uint256 private constant ARM2_UNDERCUT_CENTI_BPS = __ARM2_UNDERCUT_CENTI_BPS__;
    uint256 private constant ARM2_BUFFER_CENTI_BPS = __ARM2_BUFFER_CENTI_BPS__;

    uint256 private constant ARM3_BAND_BPS = __ARM3_BAND_BPS__;
    uint256 private constant ARM3_TIGHT_CENTI_BPS = __ARM3_TIGHT_CENTI_BPS__;
    uint256 private constant ARM3_UNDERCUT_CENTI_BPS = __ARM3_UNDERCUT_CENTI_BPS__;
    uint256 private constant ARM3_BUFFER_CENTI_BPS = __ARM3_BUFFER_CENTI_BPS__;

    // Context-arm score bonuses (scale: 1e6 = +1.0 score).
    uint256 private constant CALM_BIAS_ARM1_MILLI = __CALM_BIAS_ARM1_MILLI__;
    uint256 private constant CALM_BIAS_ARM2_MILLI = __CALM_BIAS_ARM2_MILLI__;
    uint256 private constant CALM_BIAS_ARM3_MILLI = __CALM_BIAS_ARM3_MILLI__;

    uint256 private constant NORMAL_BIAS_ARM1_MILLI = __NORMAL_BIAS_ARM1_MILLI__;
    uint256 private constant NORMAL_BIAS_ARM2_MILLI = __NORMAL_BIAS_ARM2_MILLI__;

    uint256 private constant STRESS_BIAS_ARM0_MILLI = __STRESS_BIAS_ARM0_MILLI__;
    uint256 private constant STRESS_BIAS_ARM1_MILLI = __STRESS_BIAS_ARM1_MILLI__;
