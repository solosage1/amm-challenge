...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant MICRO_ALPHA_PCT = __MICRO_ALPHA_PCT__;
    uint256 private constant MICRO_DECAY_PCT = __MICRO_DECAY_PCT__;
    uint256 private constant MICRO_MOVE_CAP_BPS = __MICRO_MOVE_CAP_BPS__;
    uint256 private constant MICRO_DEADBAND_BPS = __MICRO_DEADBAND_BPS__;
    uint256 private constant MICRO_TILT_DIV = __MICRO_TILT_DIV__;
    uint256 private constant MICRO_MAX_TILT_BPS = __MICRO_MAX_TILT_BPS__;

    uint256 private constant QUEUE_ALPHA_PCT = __QUEUE_ALPHA_PCT__;
    uint256 private constant QUEUE_DECAY_PCT = __QUEUE_DECAY_PCT__;
    uint256 private constant QUEUE_TRIGGER = __QUEUE_TRIGGER__;
    uint256 private constant QUEUE_STEP_BPS = __QUEUE_STEP_BPS__;
    uint256 private constant QUEUE_MAX_BPS = __QUEUE_MAX_BPS__;
    uint256 private constant QUEUE_DEADBAND_BPS = __QUEUE_DEADBAND_BPS__;
    uint256 private constant QUEUE_TILT_DIV = __QUEUE_TILT_DIV__;
    uint256 private constant QUEUE_MAX_TILT_BPS = __QUEUE_MAX_TILT_BPS__;
    uint256 private constant QUEUE_GAP_RESET = __QUEUE_GAP_RESET__;

    uint256 private constant SIGNAL_FLOW_W_PCT = __SIGNAL_FLOW_W_PCT__;
    uint256 private constant SIGNAL_MICRO_W_PCT = __SIGNAL_MICRO_W_PCT__;
    uint256 private constant SIGNAL_QUEUE_W_PCT = __SIGNAL_QUEUE_W_PCT__;
    uint256 private constant EXTRA_TILT_MAX_BPS = __EXTRA_TILT_MAX_BPS__;

    uint256 private constant WIDE_SIGNAL_DIV = __WIDE_SIGNAL_DIV__;
    uint256 private constant WIDE_SIGNAL_MAX_BPS = __WIDE_SIGNAL_MAX_BPS__;
    uint256 private constant WIDE_COMP_BONUS_PCT = __WIDE_COMP_BONUS_PCT__;
    uint256 private constant WIDE_PROTECT_BONUS_PCT = __WIDE_PROTECT_BONUS_PCT__;
