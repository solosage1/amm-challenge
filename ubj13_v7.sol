...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_ALPHA_PCT = 22;
    uint256 private constant INV_DEADBAND_BPS = 6;
    uint256 private constant INV_DIV = 4;
    uint256 private constant INV_MAX_BPS = 7;

    uint256 private constant SKEW_ALPHA_PCT = 24;
    uint256 private constant SKEW_DEADBAND_BPS = 5;
    uint256 private constant SKEW_DIV = 4;
    uint256 private constant SKEW_MAX_BPS = 8;
    uint256 private constant SKEW_STREAK_BONUS_BPS = 3;

    uint256 private constant BIAS_ENTER_BPS = 2;
    uint256 private constant BIAS_FLIP_BPS = 5;
    uint256 private constant BIAS_HOLD_STEPS = 3;
