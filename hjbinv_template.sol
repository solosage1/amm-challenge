...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant TIGHT_FEE_CENTI_BPS = __TIGHT_FEE_CENTI_BPS__;
    uint256 private constant UNDERCUT_CENTI_BPS = __UNDERCUT_CENTI_BPS__;
    uint256 private constant BUFFER_CENTI_BPS = __BUFFER_CENTI_BPS__;
    ...
    uint256 private constant FLOW_ALPHA_PCT = __FLOW_ALPHA_PCT__;
    uint256 private constant FLOW_DECAY_PCT = __FLOW_DECAY_PCT__;
    uint256 private constant FLOW_DEADBAND_BPS = __FLOW_DEADBAND_BPS__;
    uint256 private constant FLOW_TILT_DIV = __FLOW_TILT_DIV__;
    uint256 private constant FLOW_MAX_TILT_BPS = __FLOW_MAX_TILT_BPS__;
    uint256 private constant FLOW_IMPULSE_CAP_BPS = __FLOW_IMPULSE_CAP_BPS__;
    uint256 private constant FLOW_CLAMP_BPS = 500;

    // Post-arb retightening.
    uint256 private constant ARB_TAG_MIS_BPS = __ARB_TAG_MIS_BPS__;
    uint256 private constant POST_ARB_CUT_BPS = __POST_ARB_CUT_BPS__;

    // HJB-like inventory controls for wide-regime quoting.
    uint256 private constant INV_WIDE_DEADBAND_BPS = __INV_WIDE_DEADBAND_BPS__;
    uint256 private constant INV_WIDE_DIV = __INV_WIDE_DIV__;
    uint256 private constant INV_WIDE_MAX_BPS = __INV_WIDE_MAX_BPS__;
    uint256 private constant INV_COMP_BONUS_PCT = __INV_COMP_BONUS_PCT__;
    uint256 private constant INV_PROTECT_BUFFER_PCT = __INV_PROTECT_BUFFER_PCT__;
