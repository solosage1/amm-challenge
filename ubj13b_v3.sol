...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_DIV = 7;
    uint256 private constant INV_MAX_BPS = 3;

    uint256 private constant STREAK_ENTER = 3;
    uint256 private constant STREAK_FLIP_BPS = 3;
    uint256 private constant STREAK_BONUS_MAX_BPS = 3;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 65;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 45;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 20;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 65;
    uint256 private constant BIAS_COMP_MAX_BPS = 3;
    uint256 private constant BIAS_PROTECT_MAX_BPS = 3;
