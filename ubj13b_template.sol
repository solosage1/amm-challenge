...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_DEADBAND_BPS = __INV_DEADBAND_BPS__;
    uint256 private constant INV_DIV = __INV_DIV__;
    uint256 private constant INV_MAX_BPS = __INV_MAX_BPS__;

    uint256 private constant STREAK_ENTER = __STREAK_ENTER__;
    uint256 private constant STREAK_FLIP_BPS = __STREAK_FLIP_BPS__;
    uint256 private constant STREAK_BONUS_MAX_BPS = __STREAK_BONUS_MAX_BPS__;

    uint256 private constant ALIGN_COMP_BONUS_PCT = __ALIGN_COMP_BONUS_PCT__;
    uint256 private constant MISALIGN_COMP_CUT_PCT = __MISALIGN_COMP_CUT_PCT__;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = __ALIGN_PROTECT_CUT_PCT__;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = __MISALIGN_PROTECT_BONUS_PCT__;
    uint256 private constant BIAS_COMP_MAX_BPS = __BIAS_COMP_MAX_BPS__;
    uint256 private constant BIAS_PROTECT_MAX_BPS = __BIAS_PROTECT_MAX_BPS__;
    uint256 private constant TIGHT_INV_TILT_MAX_BPS = __TIGHT_INV_TILT_MAX_BPS__;
