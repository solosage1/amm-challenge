# Experiment E-003 — GammaSquaredDualRegime

- Date: 2026-02-10
- Hypothesis: H-baseline
- Strategy file: `.ralph-amm/phase7/generated/phase7_strategy_18.sol`
- Git SHA: `45db8c5`
...
```bash
python scripts/amm-test-pipeline.py .ralph-amm/phase7/generated/phase7_strategy_18.sol \
