...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant ARM0_UNDERCUT_CENTI_BPS = 990;
    uint256 private constant ARM1_UNDERCUT_CENTI_BPS = 1050;
    uint256 private constant ARM2_UNDERCUT_CENTI_BPS = 1125;

    uint256 private constant ARM0_BUFFER_CENTI_BPS = 225;
    uint256 private constant ARM1_BUFFER_CENTI_BPS = 200;
    uint256 private constant ARM2_BUFFER_CENTI_BPS = 178;
    ...
    uint256 private constant META_RISK_ALPHA_PCT = 20;
    uint256 private constant META_MAG_CAP_BPS = 14;
    uint256 private constant META_CLAMP_BPS = 520;

    uint256 private constant RISK_ARM_TRIG_BPS = 35;
    uint256 private constant AGGR_ARM_TRIG_BPS = 23;
    uint256 private constant AGGR_MAX_RISK_BPS = 24;

    uint256 private constant CONF_GATE_BPS = 4600;
    uint256 private constant CONF_UP_BPS = 95;
    uint256 private constant CONF_DOWN_BPS = 150;
    uint256 private constant CONF_MISS_BPS = 45;
