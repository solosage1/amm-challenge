...
/// @notice Gamma-squared dual regime but with higher fees when near fair,
///         intentionally yielding low-margin tight-band flow to the normalizer.
contract Strategy is AMMStrategyBase {
    ...
    function getName() external pure override returns (string memory) {
        return "GammaSquaredDualRegime_Tight40";
    }
}
