...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant INV_DEADBAND_BPS = 7;
    uint256 private constant INV_DIV = 5;
    uint256 private constant INV_MAX_BPS = 6;

    uint256 private constant STREAK_ENTER = 2;
    uint256 private constant STREAK_FLIP_BPS = 6;
    uint256 private constant STREAK_BONUS_MAX_BPS = 6;

    uint256 private constant ALIGN_COMP_BONUS_PCT = 120;
    uint256 private constant MISALIGN_COMP_CUT_PCT = 15;
    uint256 private constant ALIGN_PROTECT_CUT_PCT = 40;
    uint256 private constant MISALIGN_PROTECT_BONUS_PCT = 120;
    uint256 private constant BIAS_COMP_MAX_BPS = 7;
    uint256 private constant BIAS_PROTECT_MAX_BPS = 7;
    uint256 private constant TIGHT_INV_TILT_MAX_BPS = 2;
