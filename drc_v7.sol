...
contract Strategy is AMMStrategyBase {
    ...
    uint256 private constant STRESS_ENTER_BPS = 78;
    uint256 private constant STRESS_EXIT_BPS = 52;

    uint256 private constant AMBIGUITY_PCT = 25;
    uint256 private constant VOL_WEIGHT_PCT = 15;
    uint256 private constant ADV_REPLAY_WEIGHT_PCT = 25;

    uint256 private constant CVAR_TAIL_TRIGGER_BPS = 4;
    uint256 private constant CVAR_TAIL_WEIGHT_PCT = 120;

    uint256 private constant STRESS_UNDERCUT_CUT_CENTI_BPS = 90;
    uint256 private constant STRESS_BUFFER_ADD_CENTI_BPS = 20;
    uint256 private constant STRESS_BAND_CUT_BPS = 1;

    uint256 private constant PANIC_SCORE_BPS = 105;
